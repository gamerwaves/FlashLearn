<!-- /Users/dwait/Documents/Coding/Shipwrecked/FlashLearn/src/routes/signup/+page.svelte -->
<script lang="ts">
		...
		<Card class="p-8 shadow-xl">
			<div class="text-center mb-8">
				...
				<P class="text-gray-600">
					Join FlashLearn and start your learning journey today
				</P>
			</div>
			...
			<form on:submit|preventDefault={handleSignup} class="space-y-6">
				<div>
					<Label for="fullname" class="text-gray-700 font-medium">Full Name</Label>
					<Input 
						id="fullname" 
						type="text" 
				...
				<div>
					<Label for="confirm-password" class="text-gray-700 font-medium">Confirm Password</Label>
					<Input 
						id="confirm-password" 
						type="password" 
			...
			<div class="mt-6 text-center">
				<P class="text-gray-600">
					...
					<a href="/login" class="text-orange-500 hover:text-orange-600 font-semibold">Sign in here</a>
				</P>
			</div>
		</Card>
	</div>
